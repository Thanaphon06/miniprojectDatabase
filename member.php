        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    ...
                    $query = "SELECT member.m_id ,customer.c_name, member.m_email, member.m_phone, member.m_address FROM member INNER JOIN customer ON member.c_id = customer.c_id;"; 
                ...
                { 
                    ...
                    { 
                        ...
                        echo "<tr>";
                        echo "<td>" . $query_executed['m_id'] . "</td>";
                        echo "<td>" . $query_executed['c_name'] . "</td>";
                        echo "<td>" . $query_executed['m_email'] . "</td>";
                        echo "<td>" . $query_executed['m_phone'] . "</td>";
                        echo "<td>" . $query_executed['m_address'] . "</td>";
                    //    echo "<td>" . $query_executed['e_sex'] . "</td>";
                      //  echo "<td>" . $query_executed['e_position'] . "</td>";
